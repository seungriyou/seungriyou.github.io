...
- 무엇을 묻고 있는지 메모한다.
- <details>
    <summary><span class="hl">주제마다 자주 사용하는 용어 및 표현</span>을 떠올리고 메모한다.</summary>
    <div markdown="1">

    - **면접**
        - applicant
        - apply for ~ position
        - will interview sb / have an interview with sb
        - have ~ years of experience
    - **일정표**
        - arrive in sw / depart sw
        - have dinner at _ P.M / have lunch with sb
        - a few items on your schedule
        - ___ Airlines flight number ~
    - **강연, 행사**
        - seminar is going to be held on ~
        - there is no need for you to v
        - will lead ~ / will be led by sb
        - give a lecture / speech
        - talk about
        - will make closing remarks
        - will last for ~ hours
    - **이력서**
        - 현재 직업: current job is sth / ~ has worked as sth / ~ has been at sw as sth
        - 과거 직업: worked as sth / was sth at sw
        - got / earned / received a bachelor’s / master’s degree in (분야) from ___ University in 2003
        - graduated from ___ University with a bachelor’s / master’s degree in (분야)
    - **예약표**
        - ~~ activity cost $50 for 30 minutes rental
        - (recommend 시) could
        - go -ing / do the ~~ activity
        - for $5 per person
    - **주문서**
        - due upon sth
        - Inc: incorporated
        - which cost $3 per box / at $5 each
...
- **반반 템플릿 (Q7 선호 문제)**
    ...
    Well, I think it’s fifty-fifty. Sometimes A, but sometimes B. It depends.
...
- near the library / park
- have very friendly staff
- interior design is fresh and modern
- you’d like the atmosphere there
- more likely to find ~
- form a good habit
- reliable, portable
- by force of habit (습관적으로)
- can enjoy various types of activities there
...
- made it possible to v
- have more flexibility
- become stressed out
- set aside a lot of time for sth
- have a desire for a ___
- foster friendships
- feel togetherness with other people
- come up with sth
- invasion of privacy
- feel a sense of accomplishment
- common ground
- damage sb’s eyesight
- make excuses
...
![성적](/assets/img/posts/Daily-Log/2024-01-19-02.png){: .w-50}
